...
class updateData extends Command
{
     ...
     * @var string
     */
    protected $description = 'Update the data of the users every 24 hours';
   ...
   function curl($url) {
    ...
    function report($day,$client){
        $report_day = $client->requestReport(
            ...
            "metrics" => "campaignName,campaignId,campaignStatus,campaignBudget,attributedConversions1d,attributedConversions7d,attributedConversions14d,attributedConversions30d,attributedConversions1dSameSKU,attributedConversions7dSameSKU,attributedConversions14dSameSKU,attributedConversions30dSameSKU,attributedUnitsOrdered1d,attributedUnitsOrdered7d,attributedUnitsOrdered14d,attributedUnitsOrdered30d,attributedSales1d,attributedSales7d,attributedSales14d,attributedSales30d,attributedSales1dSameSKU,attributedSales7dSameSKU,attributedSales14dSameSKU,attributedSales30dSameSKU,impressions,clicks,cost"));
    ...
    //    }  
       //  set days to sync
        ...
        $arrayDay = array();
        for( $i = 1; $i <= $days ; $i++ ) {
            array_push($arrayDay,date('Ymd', strtotime('-'.$i.'day', strtotime('20190728')))); 
        }
